...
namespace HomeWork3
{
    public class HW3
    {
        ...
        {
            int a = GetNumberForUser("Введите число а");
            int nd = SearchesForTheGreatestCommonFactor(a);
        ...
        public void SolveTask6()
        {
            ...
            int Fibonachi = FindsTheNumberOfAFibbanachiNumber(valueN);
        ...
        public void SolveTask7()
        {
            int a = GetNumberForUser("Введите число а");
            int b = GetNumberForUser("Введите число b");
            int nod = SearchesForNODViaEuclidTheorem(a, b);
        ...
        public int SearchesForTheGreatestCommonFactor(int a)
        {
            int nd = 1;
            for (int i = 1; i < a; i++)
            {
        ...
        public int FindsTheNumberOfAFibbanachiNumber(int valueN)
        {
            int fibonachiN = 1;
            int previous1 = 0;
            int previous2 = 1;
        ...
        public int SearchesForNODViaEuclidTheorem(int a, int b)
        {
            int nod = 1;
            int tmpEvklid = 0;
            if (a > b)
